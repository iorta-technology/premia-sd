    ...
    <div className="cards-container">
      <div className="dropdown-container">
          <div className="round-card-main-Tab">
            {checkAgent() === false && (
              <>
                <div className="CardBodySelf lead-ml60" style={{ display:'flex',flexDirection:'row',marginBottom: 25 }}>
                  <button
                  ...
                  <button
                    style={{ width: 95,display:'flex',marginLeft:15,alignItems:'center',justifyContent:'center' }}
                    className={!TeamSelf ? "activateSelf" : ""}
