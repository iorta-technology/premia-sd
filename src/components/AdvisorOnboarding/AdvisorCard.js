...
const LeadCard = React.memo((props) => {
  ...
  let card = (
    ...
    <Row className="advisor-card" align="top" justify="center">
      ...
      <Col span={12}>
        <p className="paragraph capitalize advisor-name font-bold">
          {firstName}
        </p>
        <p className="paragraph capitalize app-id-label font-bold">
          App ID <span className="app-id">{policyId}</span>
        </p>
      </Col>
      <Col span={10}>
        <Row justify="center" align="middle">
          ...
          <Col span={7}>
            <Row justify="end" align="middle">
              ...
              <Col span={20}>
                <p className="paragraph capitalize lead-status font-bold">
                  {proposalStatus}
                </p>
              </Col>
            </Row>
            ...
            <Row justify="end" align="middle">
              ...
              <Col span={20}>
                <div className="lead-box">
                  <p className="paragraph capitalize lead-agent font-bold">
                    {proposalType}
                  </p>
                </div>
              </Col>
        ...
        <Row justify="center" align="middle">
          <Col span={18}>
            <Row gutter={[16, 24]}>
              ...
              <Col span={8}>
                <p className="paragraph adv-detail-label font-bold">
                  MObile No
                </p>
