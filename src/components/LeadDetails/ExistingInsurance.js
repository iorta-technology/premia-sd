...
const ExistingInsurenceDetails = () => {
  ...
  }, [insurer, lifeSumAssured, width, form]);
  ...
  const lifeInsColumn = [
    ...
    },
    {
      ...
      render: (Comencedate) => {
        return <p>{moment(Comencedate).format("DD-MM-YYYY")}</p>;
      },
    },
    {
      ...
      dataIndex: "Appdate",
      render: (Appdate) => {
        return <p>{moment(Appdate).format("DD-MM-YYYY")}</p>;
      },
    },
    {
      title: "Policy Number",
    ...
    },
    {
      ...
      render: (record) => {
        return (
          <CloseCircleOutlined onClick={() => updateLifeModalObject(record)} />
        );
      },
    },
  ];
  ...
  const healthInsColumn = [
    ...
    },
    {
      ...
      render: (dobOfInsurer) => {
        return <p>{moment(dobOfInsurer).format("DD-MM-YYYY")}</p>;
      },
    },
    {
      title: "Plan Name",
    ...
    },
    {
      ...
      render: (record) => {
        return (
          <CloseCircleOutlined
            onClick={() => updateHealthModalObject(record)}
          />
        );
      },
    },
