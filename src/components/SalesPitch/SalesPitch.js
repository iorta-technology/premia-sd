        ...
        <div>
            ...
            <div className="Salespitch-main">
                ...
                <div className="Salespitch-row-flex">
                    <Tabs tabPosition={tabPosition} tabBarGutter="3vw" >
                                        ...
                                        <Col xs={{ order: 2 }} sm={8} md={8} lg={{ order: 2 }} xl={{ order: 2 }} span={22}>
                                            <Row>
                                                <Col className="Salespitch-img2" xs={22} sm={24} md={24} lg={24} xl={24} span={24} >
                                                    <Card>
                                                        <div className="c2">
                                                            <Image src="../../img1.jpg" style={{ width: '20vw', height: '29vh' }} />
                                                        </div>
                                                        <div className="c2">
                                        ...
                                        <Col xs={{ order: 3 }} sm={24} md={24} lg={{ order: 3 }} xl={{ order: 3 }} span={22}>
                                            <Row gutter={['', 24]}>
                                                <Col className="presentation-img" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                    ...
                                                    <p className="headingg1">COMPANY PROFILE</p>
                                            ...
                                            <Row gutter={[16, 16]}>
                                                <Col xs={24} sm={12} md={8} lg={8} xl={8} span={24}>
                                                    <div >
                                                        <Card bordered={true} >
                                                            <div className="i1">
                                                                <Image src="../../img1.jpg" style={{ width: '22vw', height: '26vh' }} />
                                                ...
                                                <Col xs={24} sm={12} md={8} lg={8} xl={8} span={24}>
                                                    <div >
                                                        <Card bordered={true} >
                                                            <div className="i1">
                                                                <Image src="../../i2.jpg" style={{ width: '24vw', height: '26vh' }} />
                                                                <div className="demo-nav">
                                                ...
                                                <Col xs={24} sm={12} md={8} lg={8} xl={8} span={24}>
                                                    <div >
                                                        <Card bordered={true} >
                                                            <div className="i1">
                                                                <Image src="../../i4.JPG" style={{ width: '24vw', height: '26vh' }} />
                                                                <div className="demo-nav">
                                                ...
                                                <Col xs={24} sm={12} md={8} lg={8} xl={8} span={24}>
                                                    <div ><Card bordered={true} >
                                                        <div className="i1">
                                                            <Image src="../../i6.png" style={{ width: '24vw', height: '26vh' }} />
                                                            <div className="demo-nav">
                                                ...
                                                <Col xs={24} sm={12} md={8} lg={8} xl={8} span={24}>
                                                    <div ><Card bordered={true} >
                                                        <div className="i1">
                                                            <Image src="../../i7.jpg" style={{ width: '24vw', height: '26vh' }} />
                                                            <div className="demo-nav">
                                                ...
                                                <Col xs={24} sm={12} md={8} lg={8} xl={8} span={24}>
                                                    <div ><Card bordered={true} >
                                                        <div className="i1">
                                                            <Image src="../../i8.png" style={{ width: '22vw', height: '26vh' }} />
                                                            <div className="demo-nav">
                                                ...
                                                <Col xs={24} sm={12} md={8} lg={8} xl={8} span={24}>
                                                    <div ><Card bordered={true} >
                                                        <div className="i1">
                                                            <Image src="../../i9.JPG" style={{ width: '24vw', height: '26vh' }} />
                                                            <div className="demo-nav">
                                                ...
                                                <Col xs={24} sm={12} md={8} lg={8} xl={8} span={24}>
                                                    <div ><Card bordered={true} >
                                                        <div className="i1" >
                                                            <Image src="../../i10.png" style={{ width: '22vw', height: '26vh' }} />
                                                            <div className="demo-nav">
                                                                <Link>TATA AIG</Link>
                                                            </div>
                                                        </div>
                                    ...
                                    <Col xs={{ order: 2 }} sm={12} md={12} lg={{ order: 2 }} xl={{ order: 2 }} span={22}>
                                        <Row gutter={['', 24]}>
                                            <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                <h1 className="headingg">Mahindra Insurance Brokers Limited</h1>
                                                <p className="headingg3">MIBL's aim is to play a predominant role in the insurance broking industry in India with a focus on value to customers, innovative solutions, superior services, professional manpower and Corporate Social Responsibility. To further strengthen its commitment to being a Customer Centric Company, MIBL is now proud to be one of the few insurance broking companies in India who have been awarded the prestigious ISO 9001:2015 Certification for Quality Management Systems. Adopting Quality Management Systems ensures standardization of validated processes, measuring and monitoring of customer satisfaction levels for improvement, and setting and achieving quality objectives for excellence.</p>
                                                <h2 className="headingg2">Uploaded By: Admin Khan </h2>
                                                <h3 className="headingg3">Uploaded Date: 8/19/2021</h3>
                                            </Col>
                                        </Row>
                                        ...
                                        <Row gutter={['', 24]}>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                <Title className="success-head">Mutual Fund</Title><hr />                                            <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../MUTUAL_FUND.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                ...
                                                <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../NFO.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                ...
                                                <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../fixed_deposit.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                ...
                                                <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../National_Pension_System.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                ...
                                                <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../BOnds.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                ...
                                                <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../term-insurance-plans-mobile.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                ...
                                                <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../images.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                ...
                                                <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../retirement-catpage-mob.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                ...
                                                <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../Child_Plans_Mobile_Banner.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                                            <Col className="success-story" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                ...
                                                <Form layout="horizontal" className="success-story-form">
                                                    ...
                                                    <Col xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                                        <div>
                                                            <Image src="../../group-plans-mob-new.jpg" style={{ width: '30vw', height: '50vh' }} />
                                                        </div>
                                                    </Col>
                                                </Form>
                                            </Col>
                            ...
                            <Row gutter={[16, 16]}>
                                    ...
                                    <div className='calculator-main'>
                                        <Card >
                                            <div >
                                                ...
                                                <p className="paragraph11">The Human Life Value (HLV) Calculator <br />helps you identify you life insurance <br />needs on basis of income, expenses...</p><br />
                                ...
                                <Col xs={24} sm={12} md={8} lg={8} xl={8} span={24}>
                                    <div className='calculator-main'>
                                        <Card >
                                            <div>
                                                <h1 className="Heading">Retirement

                                                    Calculator</h1>
                                                <p className="paragraph11">The retirement calculator helps you to create a secure retirement plan.View retirement savings balance...</p><br /><br />
                                                <Button className="btnn">Calculate</Button>
                                            </div>
                                        </Card>
                                    </div>
