    ...
    return <Fragment >
        {/* <Header className="header">
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                ...
                <Col className="Head-center" span={8}>
                    <Image style={{ paddingLeft: '120px', paddingTop: '15px' }} width={270} src="sales.png" />
                </Col>
                <Col className="Head-right" span={8}>
                    <Image width={40} src="user.png" />
                </Col>
            </Row>
        </Header> */}
        ...
        <div className="Main-content">
           <div className="club-container">
                ...
                <Row gutter={[40, 24]} justify="start">
                    <Col xs={{ order: 2 }} sm={6} md={8} lg={{ order: 1 }} xl={{ order: 1 }} span={22}>
                        <Row gutter={['', 24]}>
                            ...
                            <Col className="card2" xs={22} sm={24} md={24} lg={24} xl={24} span={24}>
                                <div className="Card">
                                    ...
                                    <div className="card-content">
                                        <Meta title="PLATINUM PREMIER" /><Divider />
                    ...
                    <Col xs={{ order: 1 }} sm={6} md={8} lg={{ order: 2 }} xl={{ order: 2 }} span={22}>
                        <Row gutter={['', 24]}>
        ...
        {/* <Footer className="footer">
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                <Col span={24}>
                    <Title className="footer-name">Disclaimer | Terms and Condition  | Privacy Policy</Title>
                </Col>
            </Row>
        </Footer> */}
    </Fragment >
