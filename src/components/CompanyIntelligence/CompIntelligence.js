...
const CompanyIntelligence = React.memo((props) => {
  ...
  return (
    <>
      ...
      <div
        className={`form-container compIntStyle kdmStyle ${
          width > 768 ? "compIntContainer" : ""
        }`}
      >
        <Row gutter={16} style={{ margin: "0" }}>
          ...
          <Col sm={24} md={12} lg={8} xlg={8}>
            ...
            <Card bordered={false} className="app-card-head">
              <Col style={{ alignItems: "center", padding: 5 }}>
                <p
                  className="app-font"
                  style={{ color: "#444444", marginLeft: 10 }}
                >
                  Company Details
                </p>
              </Col>
              ...
              <Col style={{ padding: 10 }}>
                <Row>
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {companyDetails?.raw_company_name}
                    </p>
                  ...
                  <Col style={{ flex: 1 }}>
                    ...
                    <Tooltip
                      placement="top"
                      title={companyDetails?.industry_name}
                    >
                      <p
                        className="text-font"
                        style={{
                ...
                <Row style={{ marginTop: 10 }}>
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {companyDetails?.client_location}
                    </p>
                  ...
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {companyDetails?.tata_aig_empaneled}
                    </p>
            ...
            <Card
              bordered={false}
              style={{ marginTop: 20 }}
              className="app-card-head remarkTab"
            >
              <Tabs
                defaultActiveKey="1"
                // items={items}
              ...
              >
                <TabPane tab="Remarks" key="1">
                  ...
                  >
                    <p className="text-font" style={{ color: "#444444" }}>
                      Remarks
                    </p>
                    <PlusCircleOutlined
                  ...
                  <Col
                    ...
                    style={{
                      fontSize: "smaller",
                      height:
                        reamrkDataArr && reamrkDataArr?.length > 5
                          ? "311px"
                          : "",
                      overflowY: "auto",
                    }}
                      ...
                      reamrkDataArr
                        ...
                        .map((res, index) => (
                          <div
                            ...
                            className={
                              "mb-3 remarks_bg " +
                              (loginId == res.userId._id ? "left" : "right")
                            }
                          >
                ...
                <TabPane tab="Collaborators" key="2">
                  ...
                  >
                    ...
                    <PlusCircleOutlined
                      onClick={() => setShowCollabortrModal(true)}
                      style={{ fontSize: 18 }}
                    />
                  </Row>
                    ...
                    teamDataArr.map((res, index) => (
                      <Col style={{ padding: "0px 15px 10px 15px" }}>
                        ...
                        >
                          ...
                          <p
                            style={{ marginLeft: 10, color: "#444444" }}
                            className="text-font"
                          >
                            {res?.FullName}
                          </p>
            ...
            >
              <Row
                justify="space-between"
                style={{ alignItems: "center", padding: "5px 10px 5px 10px" }}
              >
                <p className="app-font" style={{ color: "#444444" }}>
                  Opportunity Status
                </p>
                <FormOutlined
              ...
              <Col style={{ padding: 10 }}>
                <Row>
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {opportunityDetails?.leadStatusLabel}
                    </p>
                  ...
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {checkValidity(opportunityDetails?.leadDispositionLabel)}
                    </p>
                  ...
                  <Col style={{ flex: 1 }}>
                    <Tooltip
                      placement="top"
                      title={checkValidity(
                        opportunityDetails?.leadsubDisposition
                      )}
                    >
                      <p
                        className="text-font"
                ...
                <Row style={{ marginTop: 10 }}>
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {checkValidity(opportunityDetails.appoint_Date)}
                    </p>
                  ...
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {checkValidity(opportunityDetails.appointmentTime)}
                    </p>
            ...
            >
              ...
              <Col style={{ padding: 10 }}>
                <Row>
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {checkValidity(producerVasDetails?.channel_name)}
                    </p>
                  ...
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {checkValidity(producerVasDetails?.producer)}
                    </p>
            ...
            >
              ...
              <Col style={{ padding: 10 }}>
                <Row>
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {checkValidity(expectationDetails?.client_expectations)}
                    </p>
                  ...
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {checkValidity(expectationDetails?.red_flags)}
                    </p>
                  ...
                  <Col style={{ flex: 1 }}>
                    <p className="text-font">
                      {checkValidity(expectationDetails?.our_ask)}
                    </p>
          ...
          <Col className="secnd-col-responsive" sm={24} md={14} lg={8} xlg={8}>
            ...
            <Card bordered={false} className="app-card-head">
              ...
              >
                <Row>
                  ...
                  >
                    <Badge
                      count={riskDetailsArr?.length}
                      style={{ background: "#00ACC1" }}
                    />
                  </Col>
                </Row>
                <PlusCircleOutlined
                  onClick={() => openRiskModal("create")}
                  style={{ fontSize: 20 }}
                />
              </Row>
              <div style={{ height: 1, backgroundColor: "#D8D8D8" }}></div>
              <Col style={{ padding: 10 }}>
                {riskDetailsArr?.length > 0 ? (
                  riskDetailsArr?.map((el, index) => (
                    <Collapse
                      accordion={true}
                      onChange={(text) => handleCollapse(text, el, index)}
                    ...
                    >
                      <Panel
                        ...
                        extra={
                          <div>
                            <DeleteOutlined
                              onClick={() => deleteRiskData(el, index)}
                              style={{
                                fontSize: 18,
                                marginRight: 10,
                                color: "#737373",
                            ...
                            />
                            <FormOutlined
                              onClick={() => openRiskModal("edit", el, index)}
                              style={{ fontSize: 16, color: "#737373" }}
                            />
                          </div>
                        }
                      >
                        ...
                        <Row style={{ marginTop: 10 }}>
                          ...
                          <Col style={{ flex: 1 }}>
                            ...
                            <Tooltip
                              placement="top"
                              title={el.product_for_opportunity}
                            >
                              <p
                                className="text-font"
                                style={{
            ...
            >
              ...
              >
                ...
                <Row>
                  <PlusCircleOutlined
                    onClick={() => openKDMModal("create")}
                    style={{ fontSize: 20 }}
                  />
                  <FormOutlined
                    onClick={() => openKDMModal("edit")}
                    style={{ marginLeft: 15, fontSize: 20 }}
                  />
                  <DeleteOutlined
                    onClick={() => deleteKdmData()}
                ...
                <Row>
                  {kdmDetailsArr &&
                    kdmDetailsArr?.map((el, index) => (
                      <Col
                        onClick={() => handleKdmTabs(el)}
                        className={`kdmTabs ${
                          activeKdm === el._id && "kdmTabsActive"
                        }`}
                      >
                        <p
                          style={{
              ...
              {kdmDetailsArr?.length > 0 ? (
                <Col style={{ padding: 10 }}>
                  <Row>
                    <Col style={{ flex: 1 }}>
                      <p className="text-font">
                        {checkValidity(kdmDataSet?.decision_maker_name)}
                      </p>
                    ...
                    <Col style={{ flex: 1 }}>
                      <p className="text-font">
                        {checkValidity(kdmDataSet?.designation)}
                      </p>
                  ...
                  <Row style={{ marginTop: 10 }}>
                    <Col style={{ flex: 1 }}>
                      <p className="text-font">
                        {checkValidity(kdmDataSet?.primaryContact)}
                      </p>
                    ...
                    <Col style={{ flex: 1 }}>
                      <p className="text-font">
                        {checkValidity(kdmDataSet?.emailAddress)}
                      </p>
                    ...
                    <Col style={{ flex: 1 }}>
                      <p className="text-font">
                        {checkValidity(kdmDataSet?.date_of_birth)}
                      </p>
                  ...
                  <Row style={{ marginTop: 10 }}>
                    ...
                    <Col style={{ flex: 1 }}>
                      <p className="text-font">
                        {checkValidity(kdmDataSet?.state)}
                      </p>
                    ...
                    <Col style={{ flex: 1 }}>
                      <p className="text-font">
                        {checkValidity(kdmDataSet?.branch)}
                      </p>
          ...
          <Col sm={24} md={12} lg={8} xlg={8}>
            ...
            <Card bordered={false} className="app-card-head remarkTab">
              <Tabs defaultActiveKey="1" centered onChange={remarkCollabChange}>
        ...
        <>
          <KDMDetails
            kdmDataSet={kdmType === "create" ? {} : kdmDataSet}
            showKdmModal={showKdmModal}
            setShowKdmModal={setShowKdmModal}
          />
        </>
        <>
          <ProducerVAS
            producerVasDetails={producerVasDetails}
            showVasModal={showVasModal}
            setShowVasModal={setShowVasModal}
          />
        </>
        <>
          <Expectation
            expectationDetails={expectationDetails}
            showExpectationModal={showExpectationModal}
            setShowExpectationModal={setShowExpectationModal}
          />
        </>
        <>
          <RiskDetails
            riskDataSet={riskType === "create" ? {} : riskDataSet}
        ...
        <>
          <DocUpload
            showDocumntModal={showDocumntModal}
            setShowDocumntModal={setShowDocumntModal}
            callback={callback}
          />
        </>
        <>
        ...
        <>
          <CollaboratorComp
            ...
            showCollabortrModal={showCollabortrModal}
            setShowCollabortrModal={setShowCollabortrModal}
          />
        </>
