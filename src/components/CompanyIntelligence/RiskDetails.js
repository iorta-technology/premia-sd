...
const RiskDetails = (props) => {
        ...
        if(_StoreData?.company_id?.risk_details.length > 0){
            _StoreData?.company_id?.risk_details.map(el =>{
                ...
                let _data = {
                    ...
                    tagicPresence: !el.tagic_presence_percentage ? '0' : el.tagic_presence_percentage,
    ...
    const leadInsurerItems = [
        ...
        { label: "Future Generali Insurance Company",value: "Future Generali Insurance Company" },
        { label: "Liberty General Insurance",value: "Liberty General Insurance" },
        { label: "TATA AIG",value: "TATA AIG" },
        { label: "Cholamandalam MS General Insurance",value: "Cholamandalam MS General Insurance" },
        ...
        { label: "Universal Sompo General Insurance",value: "Universal Sompo General Insurance" },
        ...
        { label: "Royal Sundaram General Insurance",value: "Royal Sundaram General Insurance" },
        ...
        { label: "Raheja QBE General Insurance Company Limited",value: "Raheja QBE General Insurance Company Limited" },
    ...
    return (
        <>
            <Col
                ...
                <div  style={{display:'flex',flex:1,justifyContent:'flex-end',marginTop:20}}>
                    <Button onClick={()=> updateRiskDetails()} style={{borderRadius:5,backgroundColor:'#3b371e',color:'#fff'}} >Save and Update</Button>
                </div>
            </Col>
