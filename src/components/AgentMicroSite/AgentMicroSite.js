...
import { Modal, message, Button, Input, Select, Form, Carousel, Spin } from 'antd';
...
const AgentMicroService = () => {
    ...
    // console.log("STORE___DATA___", new URLSearchParams(search).get('agent_id'))
    const search = useLocation().search;
    console.log("STORE___DATA___", useLocation())
                ...
                <div className="profile">
                    <div className="social">
                        ...
                        <div className="vr" style={{ height: "140px" }}></div>
                            <a href={linkedIn}><img src={linkedInIcon} alt="linkedInIcon"/></a>
                        <br />
                        <a href={twitter}><img src={twitterIcon} alt="twiterIcon"/></a>
                        <br />
                        <a href={facebook}><img src={facebookIcon} alt="facebookIcon"/></a>
                    ...
                    <div>
                        ...
                        <div className="cont" style={{ width: "50%", marginLeft: "30px", verticalAlign: 'top' }}>
                            ...
                            <button 
                                ...
                                className="primary" onClick={showModal} style={{ cursor: 'pointer' }}
                                >LEARN MORE</button>
                                &nbsp;
                                <span 
